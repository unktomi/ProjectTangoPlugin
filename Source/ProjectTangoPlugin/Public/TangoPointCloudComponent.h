...
class PROJECTTANGOPLUGIN_API UPointCloudContainer : public UObject
{
	GENERATED_BODY()
		UPointCloudContainer(const class FObjectInitializer& ObjectInitializer);
...
class PROJECTTANGOPLUGIN_API UTangoPointCloudComponent : public UActorComponent
{
	GENERATED_BODY()

		UTangoPointCloudComponent(const class FObjectInitializer& ObjectInitializer);
...
public:
	...
	* @param Target The Unreal Engine / Tango Point Cloud interface object.
	* @param ScreenPoint Point in screens-ace pixels around which the attempt to find a plane will take place..
